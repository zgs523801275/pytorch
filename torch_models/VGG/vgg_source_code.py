...
#vgg模型主要包含:
#vgg11/vgg11_bn：8个卷积层，3个全连接层
#vgg13/vgg13_bn：10个卷积层，3个全连接层
#vgg16/vgg16_bn：13个卷积层，3个全连接层
#vgg19/vgg19_bn：16个卷积层，3个全连接层
#其中vggxx_bn在每个卷积层后新增了batch方向的归一化处理
#激活函数为ReLU函数(inplace=True:直接修改上层传递的数据，节省内存空间)
