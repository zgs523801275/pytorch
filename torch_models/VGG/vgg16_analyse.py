...
>>> vgg16 = models.vgg16()
>>> vgg16
#相较于vgg13模型的区别，新增了3个卷积层(256*256/512*512/512*512)
VGG(
  (features): Sequential(
    ...
    (13): ReLU(inplace)
    #层7(与vgg13相比新增卷积层):输入通道：256, 输出通道：256, 卷积核：3*3, 卷积个数：256*256
    (14): Conv2d(256, 256, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))#add
    (15): ReLU(inplace)
...
VGG(
  (features): Sequential(
    ...
    (35): BatchNorm2d(512, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)#add
    (36): ReLU(inplace)
    (37): Conv2d(512, 512, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
    (38): BatchNorm2d(512, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)#add
    (39): ReLU(inplace)
